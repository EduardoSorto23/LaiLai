 ...
 */
public class NewDirectionFragment extends Fragment implements OnMapReadyCallback,
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootView = inflater.inflate(R.layout.fragment_new_direction, container, false);
                            ...
                            .setPositiveButton("Aceptar", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialogInterface, int i) {
                                    if (response.body().isValid()){
                                        NavHostFragment.findNavController(NewDirectionFragment.this).popBackStack();
                                    }else{
